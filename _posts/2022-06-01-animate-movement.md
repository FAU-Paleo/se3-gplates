...
![img]({{site.url}}{{site.baseurl}}images/model/2.png)
...
![img]({{site.url}}{{site.baseurl}}images/model/3.png)
...
![img]({{site.url}}{{site.baseurl}}images/model/4.png)
...
![img]({{site.url}}{{site.baseurl}}images/model/5.png)
...
![img]({{site.url}}{{site.baseurl}}images/model/6.png)

By default, the window opens up with *Export Time Sequence of Snapshots* selected. 

Similar to the individual snapshots, you first have to select what you want to export, and what the target directory is. [See this point]({{site.url}}{{site.baseurl}}features/#exporting-snapshots) on how to configure these.

![img]({{site.url}}{{site.baseurl}}images/model/7.png)
...
![img]({{site.url}}{{site.baseurl}}images/model/8.png)
