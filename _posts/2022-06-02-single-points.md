---
layout: post
title:  "Single point reconstructions"
date:   2022-06-02 
categories: jekyll update
permalink: /singlepoint/
---
...
To illustrate the problems, let's open the PaleoMap rotation file and the corresponding polygons, as in the [previous tutorial]({{site.baseurl}}timerasters/#Other-tectonic-reconstructions):

![img]({{site.url}}{{site.baseurl}}images/singlepoint/1.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/5.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/6.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/7.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/8.png)

After this step, you should still see the new point. 

![img]({{site.url}}{{site.baseurl}}images/singlepoint/9.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/10.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/11.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/12.png)

to move the point to its desired position (look at the right-hand pane). 

![img]({{site.url}}{{site.baseurl}}images/singlepoint/13.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/14.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/15.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/16.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/19.png)

Now the point will move with plates, and you can trace how it moves over time:

![img]({{site.url}}{{site.baseurl}}images/singlepoint/20.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/21.png)

Click on the **Use focussed feature** button!

![img]({{site.url}}{{site.baseurl}}images/singlepoint/22.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/23.png)
...
![img]({{site.url}}{{site.baseurl}}images/singlepoint/24.png)
