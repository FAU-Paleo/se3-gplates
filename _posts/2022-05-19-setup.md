...
![img]({{site.url}}{{site.baseurl}}images/setup/1.png)

Clicking on 'Latest GPlates release v2.3' will open up the GPlates download page.

![img]({{site.url}}{{site.baseurl}}images/setup/2.png)
...
![img]({{site.url}}{{site.baseurl}}images/setup/3.png)
...
![img]({{site.url}}{{site.baseurl}}images/setup/6.png)
...
![img]({{site.url}}{{site.baseurl}}images/setup/10.png)
...
![img]({{site.url}}{{site.baseurl}}images/setup/11.png)
...
![img]({{site.url}}{{site.baseurl}}images/setup/12.png)
...
![img]({{site.url}}{{site.baseurl}}images/setup/13.png)
...
![img]({{site.url}}{{site.baseurl}}images/setup/14.png)
