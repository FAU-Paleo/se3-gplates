...
![img]({{site.url}}{{site.baseurl}}images/rasters/VetorVSRasterFeatures_550_550.gif)
...
![img]({{site.url}}{{site.baseurl}}images/rasters/1.png)

Installed examples are in the **GeoData**/**Rasters** directory. 

![img]({{site.url}}{{site.baseurl}}images/rasters/2.png)
...
![img]({{site.url}}{{site.baseurl}}images/rasters/5.png)
...
![img]({{site.url}}{{site.baseurl}}images/rasters/6.png)

The images changes as such, when you select the BrBG palette:

![img]({{site.url}}{{site.baseurl}}images/rasters/7.png)
...
![img]({{site.url}}{{site.baseurl}}images/rasters/10.png)
...
These rasters mostly serve as visualization purpose and guidelines for reconstructions. They do not change when the reconstruction date is changed - unless they are [time-dependendent rasters]({{site.baseurl}}timerasters). 
