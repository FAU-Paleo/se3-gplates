...
![img]({{site.url}}{{site.baseurl}}images/multipoint/glossopteris-leaves.png)
...
![img]({{site.url}}{{site.baseurl}}images/multipoint/stem.jpeg)
...
![img]({{site.url}}{{site.baseurl}}images/multipoint/glossopteris-distribution.webp)
...
![img]({{site.url}}{{site.baseurl}}images/multipoint/1.png)

# Prepared occurrences

Downloading these data and formatting it to be imported to GPlates is somewhat beyond the scope of the tutorial. To make this easier the coordinates are prepared in a compressed zip file. You can download them from [here]({{site.url}}{{site.baseurl}}download/Glossopteris.zip).
...
![img]({{site.url}}{{site.baseurl}}images/multipoint/2.png)
...
![img]({{site.url}}{{site.baseurl}}images/multipoint/3.png)

Openning this file will open a dialogue box. 

![img]({{site.url}}{{site.baseurl}}images/multipoint/4.png)
...
![img]({{site.url}}{{site.baseurl}}images/multipoint/5.png)
...
![img]({{site.url}}{{site.baseurl}}images/multipoint/6.png)
