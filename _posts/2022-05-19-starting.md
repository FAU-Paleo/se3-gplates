---
layout: post
title:  "Starting GPlates and the user interface"
date:   2022-05-19 
...
![img]({{site.url}}{{site.baseurl}}images/start/1.png)

# User Interface

By default, two windows are opened a **log** window and the **main** window of GPlates.

![img]({{site.url}}{{site.baseurl}}images/start/2.png)
...
![img]({{site.url}}{{site.baseurl}}images/start/3.png)

The main window has these main panels:

![img]({{site.url}}{{site.baseurl}}images/start/MainWindow.png)
...
![img]({{site.url}}{{site.baseurl}}images/start/5.png)
